...
| Übernahme standbewusst machen | I-14 | ❓ offen — **Stufe 2c**. `CourseCarryoverService` überträgt beim Versionswechsel weiter genau einen Anschluss je Fahrt; bei einer verzweigten Kette fehlt der zweite. Ebenso offen: `CourseSequenceService` arbeitet je Linien-Version und ist davon kaum betroffen, das ist aber nicht nachgemessen |
