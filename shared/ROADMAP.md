...
| `CourseSequenceService` gegen verzweigte Ketten prüfen | I-14 | ❓ offen — er arbeitet je Linien-Version und ist vermutlich kaum betroffen (`chainOf()` liefert seit Stufe 2a die ganze Menge, und er braucht nur sie). Nicht nachgemessen |
